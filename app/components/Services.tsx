...
export default function Services() {
  return (
    <section id="services" className="bg-gradient-to-br from-pink-100 via-purple-100 to-blue-100 py-16 md:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-white p-8 md:p-12 rounded-3xl shadow-lg hover:shadow-xl transition-shadow">
